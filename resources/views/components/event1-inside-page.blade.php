<div class="bg-[#F9F9F9]">
    <div
        ...
        <div
            class="text-white bg-black bg-opacity-75 p-5 py-20 md:p-10 md:py-32 lg:p-20 lg:py-40 flex flex-col gap-5 md:gap-10">
    ...
    <div class="container mx-auto flex flex-col lg:flex-row gap-5 md:gap-10 p-5 md:p-10md:py-20 lg:py-32 ">
        <section class="w-full lg:w-2/3 bg-slate-100">
            <img src="assets/events/event1.webp" alt="exhibition_stand_1" />
            <div class="p-3 md:p-5 lg:p-10 flex flex-col gap-5 text-justify">
                ...
                <!-- Button Container -->
                <div class="flex flex-col lg:flex-row uppercase text-lg md:text-xl gap-5 md:gap-3">

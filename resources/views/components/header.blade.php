<!-- Header Component -->
<header class="bg-black bg-opacity-35 fixed w-full top-0 z-50 transition duration-300 font-poppins">
    <nav class="container mx-auto flex items-center justify-between p-4">
        <!-- Logo -->
        <a href="/" class="flex items-center">
            <img src="assets/white png2.png" alt="Xpro Services Company Logo" width="110" class="px-2"
                loading="eager" />
        </a>
    ...
    <ul id="mobileNavbarMenu"
        class="hidden lg:hidden fixed inset-x-0 p-28  top-26 h-full bg-black bg-opacity-60 duration-500 flex-col items-center space-y-10 z-60 text-4xl">
        <li><a href="/" class="text-white hover:text-gray-300">HOME</a></li>
        <li><a href="/about_us" class="text-white hover:text-gray-300">ABOUT US</a></li>
        <li><a href="./portfolio.html" class="text-white hover:text-gray-300">CALENDAR</a></li>
